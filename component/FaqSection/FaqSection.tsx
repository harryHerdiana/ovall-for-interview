...
const FaqSection: React.FC<IFaqSectionProps> = ({
  ...
  <section className="m-auto flex flex-col max-w-site md:w-3/4 xl:w-1/2 h-auto md:p-5 md:text-center mt-50px mb-40px">
    <div className=" px-4 md:px-0 uppercase text-base font-subtitleFont">{faqTitle}</div>
    <h2 className="px-4 md:px-0 lg:mt-4 mt-2 mb-10">{faqSubtitle}</h2>
