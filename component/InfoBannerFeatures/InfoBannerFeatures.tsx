...
const InfoBannerFeatures: React.FC<IInfoBannerFeaturesProps> = ({
  ...
  <GradientRectangle
    ...
    <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 lg:items-center lg:h-max max-w-site mx-auto">
      ...
      <GradientSquare className="lg:bg-none" variantGradient={backgroundColor}>
        <ResponsiveImage
          image={image}
          className="flex justify-start md:justify-center lg:justify-center h-max lg:w-full  lg:mr-16"
        />
      </GradientSquare>
    </div>
  </GradientRectangle>
